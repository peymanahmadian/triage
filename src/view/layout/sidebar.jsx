...
const Sidebar=()=>{
    return(<aside className={"sidebar"}>
        ...
        <div className={"username"}>
            ...
            <div className={"showText"}><div>1399/08/08</div><div>ورود</div></div>
            <div className={"showText"}><div>1399/08/08</div><div>خروج</div></div>
        </div>
        <div className={"operation"}>
            <div className={"titleLine"}><div>نوع تریاژ</div><div><hr/></div><div>icon</div></div>
            <Button block className={"marginBottom"}>تریاژ سطح 4 و 5 </Button>
            <Button block > تریاژ عمومی و سطح حیاتی </Button>
        </div>
        <div className={"report"}>
            <div className={"titleLine"}><div>گزارشات</div><div><hr/></div><div>icon</div></div>
        ...
        <div className={"footerSide"}>
            ...
            <div className={"info"}>
                ...
                <div><span>45*</span><span>تعداد بیماران</span></div>
            </div>
        </div>
